                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              padding: EdgeInsets.symmetric(
                                  vertical: 8.h, horizontal: 48.w),
                              decoration: BoxDecoration(
                                color: (widget.coffeeModel.type == 'S')
                                    ? AppColors.black
                                    : AppColors.white.withOpacity(0.3),
                                border: Border.all(
                                    color: (widget.coffeeModel.type == 'S')
                            ...
                            Container(
                              padding: EdgeInsets.symmetric(
                                  vertical: 8.h, horizontal: 48.w),
                              decoration: BoxDecoration(
                                color: (widget.coffeeModel.type == 'M')
                                    ? AppColors.black
                                    : AppColors.white.withOpacity(0.3),
                                border: Border.all(
                                    color: (widget.coffeeModel.type == 'M')
                            ...
                            Container(
                              padding: EdgeInsets.symmetric(
                                  vertical: 8.h, horizontal: 48.w),
                              decoration: BoxDecoration(
                                color: (widget.coffeeModel.type == 'L')
                                    ? AppColors.black
                                    : AppColors.white.withOpacity(0.3),
                                border: Border.all(
                                    color: (widget.coffeeModel.type == 'L')
